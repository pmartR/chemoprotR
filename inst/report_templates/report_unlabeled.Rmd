...
# comparisons_df
comp_df = lab_info$comparisons_df
```
...
if(all(keepPep %in% htp_pmart$e_data$Unique_Peptide)){
   # if all peptides are less than or equal to specific msgf value, leave the dataset as is
   htp_msgf <- htp_pmart
} else {
   # otherwise filter out the invalid peptides
